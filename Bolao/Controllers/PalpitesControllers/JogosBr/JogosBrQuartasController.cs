...
namespace BolaoTeste.Controllers.PalpitesControllers.JogosBr
{
    ...
    public class JogosBrQuartasController :Controller
    {
        private readonly IPalpiteServico palpiteServico;
        public JogosBrQuartasController(IPalpiteServico gaServico)
        {
        ...
        {
            var retorno = palpiteServico.EditaJogosBrQuartas(oitavasRequest);
            return Ok(retorno);
        }
    }
}
