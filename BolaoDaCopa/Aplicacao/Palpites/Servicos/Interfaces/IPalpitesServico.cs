...
namespace BolaoDaCopa.Aplicacao.Palpites.Servicos.Interfaces
{
    public interface IPalpitesServico
    {
        ...
        Task CriarPalpiteArtilheiroBrasil(CriarPalpiteArtilheiroBrasilRequest request);
        ...
        Task<PalpiteArtilheiroBrasilResponse> RecuperarPalpiteArtilheiroBrasilAsync(string hashBolao, int idUsuario);
